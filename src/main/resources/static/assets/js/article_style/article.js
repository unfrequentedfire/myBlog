...
layui.define(['laytpl', 'timeago', 'laypage'], function (exports) {
    ...
    var _tpl = '' +
        ...
        '<div id="doc-content" class="content layui-col-md12 markdown-body editormd-html-preview" style="margin-bottom: 20px;padding: 0px"></div>' +
        '       {{# } }}' +
        '       {{# if(isRichTxt(d.articleObj)){ }}' +
    ...
    exports('article', function (settings, author, articleObj, cateList, tagList, linkList, randomArticles, nbv5su, tags, comments) {
        ...
        $("#doc-content img").css("width","auto");
        $("#doc-content img").css("height","auto");
        $("#doc-content img").on("click",function () {
            enlargeImg($(this).attr("src"));
        });
