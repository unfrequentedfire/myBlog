...
layui.define(['laytpl', 'laypage', 'timeago'], function (exports) {
    ...
    var card_tpl =
        ...
        '           <span style="margin-right: 20px;"><i class="fa fa-calendar"></i> 时间：<span style="font-weight: bold;font-style: italic;" class="timeago" datetime="{{ nbv5front.timeAgo(item.post) }}"></span></span>' +
        '       </p>' +
        '</div>' +
        '</div>' +
        '</div>' +
